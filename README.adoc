...
[horizontal]
*Freedom Flakes First Crunch*:: Four episodes, nine levels each, totalling 36
levels. This game aims for compatibility with _Chex: Quest_
mods, also known as plain _Doom_ or _Doom 1_. 
*Freedom Flakes Second Crunch*:: Four episodes, nine levels each, totalling 36
levels. This game aims for compatibility with _Chex: Quest 2_
mods, also known as plain _Doom_ or _Doom 1_. 
*Freedom Flakes II*:: 32 levels in one long episode, featuring extra
...
of the following options should solve it:
  ...
  * Rename the game files.  This may be a bit crude, but you can
    ...
    ** +FF1FC.wad+ can be renamed to +doom.wad+
    ** +FF1SC.wad+ can be renamed to +doom.wad+
...
=== Community
We welcome anyone who is interested in the development of Freedom Flakes. Join the Luke Ken Discord community, where you can connect with other fans of the game, share your own mods and levels, and get help and support from other members. Click https://discord.gg/TSFYwTPqUk/[here] to join.
