...
[horizontal]
*Freedom Flakes: Raisins Odyssey*:: Four episodes, nine levels each, totalling 36
...
*Freedom Flakes: Arena*:: A 32-level game designed for competitive deathmatch play.

The engine uses a single file, such as +FFRR.wad+, that contains
...
of the following options should solve it:
  ...
  * Rename the game files.  This may be a bit crude, but you can
    ...
    ** +Freedom Flakes.wad+ can be renamed to +doom.wad+
    ** +Freedom Flakes.wad+ can be renamed to +doom2.wad+
...
posting it on the
https://www.doomworld.com/forum/17-FreedomFlakes/[FreedomFlakes forum] on
...
We used https://github.com/freedoom.io[The Freedoom project] to make the game and is fork for FreedomFlakes