...
[horizontal]
*Freedom Flakes: Heroes Odyssey*:: Four episodes, nine levels each, totalling 36
levels. This game aims for compatibility with _Chex: Quest_
mods, also known as plain _Doom_ or _Doom 1_. 
*Freedom Flakes II: Beyond The Odyssey*:: 32 levels in one long episode, featuring extra
