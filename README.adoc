...
The https://freedoom.github.io/[Freedoom] project to make the game and is forked for FreedomFlakes.
A basic https://github.com/kgsws/doom_ace/[ACE] script for editing the game such as text and adding little small modifications to game. 
