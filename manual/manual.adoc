...
| **Flake Fury** | A quick visual indication of how your health is.
...
| **E-Spork** | 1 | If you have no ammunition, you can always fall back on punching the
...
| **Blaster** | 2 | Your starter weapon. A few shots will take down low-level
...
Normal Sugar-coated armor absorbs one third of damage you receive. For example, suppose
...
The Brown Sugar-coated Armor has slightly different behavior: in addition to being
...
Increases your health back to 100%, and enhances your E-Spork to 10x their
normal damage with extra power until the end of level.
| **Invisibility Cloak** +
...
| **Damaging Floors** |
Sweet Orange Juice and Dark chocolate sludge are just two of the types of damaging floor
